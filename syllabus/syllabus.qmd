...
The Professional Development Seminar is a platform for Master of Urban Planning (MUP) students in the [Department of Urban & Regional Planning](https://urban.illinois.edu) to facilitate the transition from planning school to practice. The seminar is structured to support students in advancing their professional goals and trajectories and to build a thriving and successful community of practitioners.
...
-   [Capstone Adoption Form](../milestones/files/02_CapstoneAdoption.pdf)

-   [Plan of Study template](../milestones/files/MUP Plan of Study Template 20240819.docx)

-   [MUP Program Handbook](../milestones/files/MUP Program Handbook 2026-2027.pdf)
...
| **Mentoring**     | 20% | Engagement with your matched mentor: completing the matching survey, scheduling and attending check-ins, and completing the December and April feedback exchanges and mentee evaluations. |
| **Milestones**    | 40% | Timely completion and engagement with seminar milestones. Production of work that exemplifies your identity as an urban planning professional. |
...
This seminar includes a mentoring component pairing each of you with a practicing planner. You will be matched in September on the basis of the intake materials and matching survey you complete in August, and you will meet with your mentor periodically across both semesters.

Mentoring is a reciprocal commitment. You are responsible for initiating and scheduling your check-ins, coming to them prepared, and completing the two structured feedback exchanges — in December and April — in which your mentor offers developmental feedback and you complete a confidential evaluation of the mentoring relationship. Those evaluations are confidential and are used to improve the seminar; they are not shared with your mentor.

### Attendance

We will meet approximately once per month for 50 minutes during the fall and spring semesters. Attendance will be taken and full participation is expected to satisfy seminar and program requirements.
...
A list of the designated University employees who, as counselors, confidential advisors, and medical professionals, do not have this reporting responsibility and can maintain confidentiality, can be found [here](https://wecare.illinois.edu/resources/students/#confidential). Other information about resources and reporting is available at [wecare.illinois.edu](https://wecare.illinois.edu).
